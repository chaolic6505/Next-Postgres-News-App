      ...
      {session ? (
        ...
        >
          <div className="relative h-5 w-5 flex-shrink-0">
            <Image fill={true} alt="Sign Out Button" src="/grey-reddit.png" />
          </div>
        ...
        >
          <div className="relative h-5 w-5 flex-shrink-0">
            <Image fill={true} alt="Sign In Button" src="/grey-reddit.png" />
          </div>
        ...
        {toggleMenu && (
          <div className="flex z-20 justify-end items-end flex-col text-center py-2 px-2 absolute top-12 -right-1.5 mt-1 scale min-w-max bg-white">
            ...
            {session ? (
              ...
              >
                <div className="relative h-5 w-5 flex-shrink-0">
                  <Image alt="Sign In Button" src="/grey-reddit.png" />
                </div>
